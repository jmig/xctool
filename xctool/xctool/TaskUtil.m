...
NSDictionary *LaunchTaskAndCaptureOutput(NSTask *task, NSString *description)
{
  ...
  NSString *stdoutOutput = [outputArrays[0] componentsJoinedByString:@"\n"];
  NSString *stderrOutput = [outputArrays[1] componentsJoinedByString:@"\n"];
